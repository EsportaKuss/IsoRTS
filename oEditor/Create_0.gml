...
#region Extra Vars
	...
	current_part = e_tile_data.floor_index;					//default part in list
	current_sprite = global.cell_sprites[current_part];		//to change the sprite Tile
